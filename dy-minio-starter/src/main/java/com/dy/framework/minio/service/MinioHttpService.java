...
public class MinioHttpService {
     ...
     */
    public ApiResult createBucket(@RequestParam("bucketName") String bucketName){
     ...
     * @return 返回ApiResult响应
     */
    public ApiResult removeBucket(@RequestParam("bucketName") String bucketName){
     ...
     * @return 返回ApiResult响应
     */
    public ApiResult uploadFile(@RequestParam("bucketName") String bucketName, @NotNull @RequestParam("file")MultipartFile file){
     ...
     * @return 返回文件名
     */
    public String upload(@RequestParam("bucketName") String bucketName, @NotNull @RequestParam("file")MultipartFile file){
        String fileName = null;
        try {
             fileName = minioFileService.save(bucketName, file.getInputStream(), file.getOriginalFilename());
        }catch (IOException e){
     ...
     * @return 返回ApiResult响应
     */
    public ApiResult deleteFile(@RequestParam("bucketName")String bucketName,@RequestParam("fileName")String fileName){
     ...
     * @param fileName 文件名称
     */
    public void download(HttpServletResponse response,@RequestParam("bucketName")String bucketName,@RequestParam("fileName")String fileName){
       try {
     ...
     * @return 返回ApiResult响应
     */
    public ApiResult deleteFiles(@RequestParam("bucketName")String bucketName, @RequestParam("fileNames")List<String> fileNames){
     ...
     * @return 返回文件外链
     */
    public String fileLink(@RequestParam("bucketName")String bucketName,@RequestParam("fileName")String fileName){
     ...
     * @return
     */
    public ApiResult fileLinkApi(@RequestParam("bucketName")String bucketName,@RequestParam("fileName")String fileName){
